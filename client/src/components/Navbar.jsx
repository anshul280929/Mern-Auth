...
const Navbar = () => {
  ...
  return (
    <div className='w-full flex justify-between items-center p-4 
        ...
        {userData ?
        <div className='w-8 h-8 rounded-full bg-black flex items-center justify-center text-white relative group'>
        ...
        className='flex items-center gap-2 border border-grey-500 rounded-full 
            px-6 py-2 text-gray-800 hover:bg-gray-100 
